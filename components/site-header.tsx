...
const components: { title: string; href: string; description: string }[] = [
  ...
  },
  {
    title: "Programação",
    href: "#",
    description: "Encontre aqui o programador e/ou desenvolvedor para o seu projecto.",
  },
  {
    title: "Carpitaria",
    href: "#",
                    ...
                    <NavigationMenuContent>
                      <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                          ...
                          <NavigationMenuLink asChild>
                            ...
                            >
                              ...
                              <p className="text-sm leading-tight text-muted-foreground">
                                Conectando Vidas e Projectos, junte-se a nós nessa grande jornada...
                              </p>
                            </a>
                          </NavigationMenuLink>
                        </li>
                        ...
                        <ListItem href="#" title="Confiança e Segurança">
                          Milhões de serviços, milhões de usuários.
                          Nossa prioridade: sua confiança e segurança
                        </ListItem>
                        <ListItem href="#" title="Guias GEPO">
                          Tudo que você precisa saber para alavancar o seu negócio
                        </ListItem>
                      </ul>
                    </NavigationMenuContent>
                  </NavigationMenuItem>
                ...
                <>
                  ...
                  <NavigationMenuList>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          <AlertDialogTitle className="text-center">Entre na sua Conta</AlertDialogTitle>
                          <AlertDialogDescription>
                            <div className="text-center">
                              Faça o seu cadastro para poder ter acesso ao seu Dashboard e
                            ...
                            <div className="my-4 flex flex-col content-center justify-center text-center">
                              ...
                              {providers && Object.values(providers).map((provider) => (
                                    <Button type="button"
                                    key={provider.name}
                                    onClick={() => signIn(provider.id)} variant="outline">Google</Button>
                                ))}
                            </div>
                            <Tabs defaultValue="account">
                              <TabsList className="grid w-full grid-cols-2">
                                <TabsTrigger value="account">Autenticação</TabsTrigger>
                                <TabsTrigger value="password">Nova Conta</TabsTrigger>
                              </TabsList>
                              <TabsContent value="account">
                                <Card>
                                  <CardHeader className="text-center">
                                    <CardTitle>Credênciais do Usuário</CardTitle>
                                    <CardDescription>                                   
                                    </CardDescription>
                                  </CardHeader>
                              ...
                              <TabsContent value="password">
                                <Card>
                                  ...
                                  <CardContent className="space-y-2">
                                    ...
                                    <p className="text-xs">
                                      Ao inscrever-se, você concorda com os Termos de Serviço da GEPO e 
                                      aceita receber nossos e-mails ocasionalmente. 
                                      Leia nossa Política de Privacidade para saber como usamos seus 
                                      dados pessoais.
                                    </p>
                                  </CardContent>
                                  <CardFooter>
              ...
              {session?.user ? (
                ...
                <NavigationMenu>
                  <NavigationMenuList>
                    <NavigationMenuItem>
                      <Avatar>
                      <AvatarImage onClick={() => setToggleDropdown((prev) => !prev)} src={session?.user?.image} alt="@shadcn" />
                  ...
                  <div className="absolute right-0 top-full mt-3 flex w-full min-w-[210px] flex-col items-end justify-end gap-2 rounded-lg bg-black p-5">
                    ...
                    <Button onClick={signOut} className="mt-5 w-full" variant="outline">Sair</Button>
                  </div>
                )}
                </NavigationMenu>
                <ThemeToggle />
