              ...
              <>
                ...
                <CardFooter className="flex justify-end">
                  ...
                  <Button
                    onClick={() =>
                      router.push(
                        `/perfil_fornecedor/${autor["creator"]["_id"]}`
                      )
                    }
                    variant="outline"
                  >
      ...
      <main className="flex-1">
        <div>
          <Card className="w-full">
            ...
            <CardContent>
              {servicoUnico.length > 0 &&
                servicoUnico.map((servico) => (
                  <div className="flex flex-row gap-4">
                    ...
                    <Card className="w-[70%]">
                      ...
                      <CardContent>{servico["descricao"]}</CardContent>
                      <CardFooter className="flex justify-between">
                  ...
                  <Sheet>
                    ...
                    <SheetContent>
                      <SheetHeader>
                        ...
                        <SheetDescription>
                          Digite o número a ser descontado o saldo do pagamento
                          do serviço
                        </SheetDescription>
                      </SheetHeader>
                      ...
                      <SheetHeader className="mt-12">
                        ...
                        <SheetDescription>
                          Ao selecionar o botão abaixo será redirecionado para a
                          pagina de autenticação bancaria
                        </SheetDescription>
                      </SheetHeader>
                      <SheetFooter>
                        <SheetClose asChild>
