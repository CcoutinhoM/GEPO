          ...
          <Card className="w-full">
            <CardHeader>
              ...
              <CardDescription>
                ...
                saberem no que você é especialista e como adquiriu suas
                habilidades, certificações e experiência.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-row gap-4">
                <HoverCard>
                  ...
                  <HoverCardContent>
                    Sua ocupação profissional é a atividade ou trabalho que você
                    exerce como meio de sustento e carreira.
                  </HoverCardContent>
                </HoverCard>
              ...
              <div className="flex flex-row gap-4">
                ...
                <Popover
                  ...
                  onOpenChange={setOpenExperiencia}
                >
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
                    ...
                    >
                      {valueExperiencia
                        ? experiencias.find(
                            (framework) => framework.value === valueExperiencia
                          )?.label
                        ...
                        {experiencias.map((framework) => (
                          ...
                          >
                            <Check
                              className={cn(
                                "mr-2 h-4 w-2",
                                valueExperiencia === framework.value
                                  ? "opacity-100"
                                  : "opacity-0"
                              )}
                            />
              ...
              <div className="flex flex-row gap-4">
                <HoverCard>
                  ...
                  <HoverCardContent>
                    Adicione alguma Informação relativa a sua formação para
                    ajudar ao comprador a conhecer-te melhor.
                  </HoverCardContent>
                </HoverCard>
              ...
              <div className="flex flex-row gap-4">
                <HoverCard>
                  ...
                  <HoverCardContent>
                    Adicione alguma Informação relativa às suas certificações
                    para ajudar ao comprador a conhecer-te melhor.
                  </HoverCardContent>
                </HoverCard>
                <div className="flex w-full flex-col gap-4">
                  <Input
